...
uses
  ...
  Menus, ComCtrls, TAGraph, Math, TASeries, TAChartUtils;
...
begin
  ...
  for Fila := 1 to StringGridDatos.RowCount - 1 do
  begin
    if TryStrToFloat(Trim(StringGridDatos.Cells[x, Fila]), valorX, FS) and
       TryStrToFloat(Trim(StringGridDatos.Cells[y, Fila]), valorY, FS) then
    begin
